...
public final class user_002droster_002ddelete_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 // Get parameters
    ...
    if (delete) {
      ...
      _jspx_th_fmt_message_1.setKey("user.roster.delete.info");
      ...
      if (_jspx_eval_fmt_message_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jspx_th_fmt_param_0.setValue( "<b>"+StringUtils.escapeForXML(jid)+"</b>" );
          ...
          _jspx_th_fmt_param_1.setValue( "<b>"+StringUtils.escapeForXML(username)+"</b>" );
  ...
  private boolean _jspx_meth_fmt_message_0(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_0.setKey("user.roster.delete.title");
  ...
  private boolean _jspx_meth_fmt_message_2(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_2.setKey("user.roster.delete.delete");
  ...
  private boolean _jspx_meth_fmt_message_3(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_3.setKey("global.cancel");
