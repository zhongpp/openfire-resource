...
public final class component_002dsession_002ddetails_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 webManager.init(request, response, session, application, out ); 
  ...
  // Get parameters
    ...
    NumberFormat numFormatter = NumberFormat.getNumberInstance();
      ...
      _jspx_th_fmt_message_1.setKey("component.session.details.info");
      ...
      if (_jspx_eval_fmt_message_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jspx_th_fmt_param_0.setValue( "<b>"+jid+"</b>" );
 ...
 try { 
  ...
  private boolean _jspx_meth_fmt_message_0(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_0.setKey("component.session.details.title");
  ...
  private boolean _jspx_meth_fmt_message_2(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_2.setKey("component.session.details.title");
  ...
  private boolean _jspx_meth_fmt_message_3(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_3.setKey("component.session.label.domain");
  ...
  private boolean _jspx_meth_fmt_message_4(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_4.setKey("component.session.label.name");
  ...
  private boolean _jspx_meth_fmt_message_5(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_5.setKey("component.session.label.category");
  ...
  private boolean _jspx_meth_fmt_message_6(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_6.setKey("component.session.label.type");
  ...
  private boolean _jspx_meth_fmt_message_7(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_7.setKey("component.session.label.creation");
  ...
  private boolean _jspx_meth_fmt_message_8(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_8.setKey("component.session.label.last_active");
  ...
  private boolean _jspx_meth_fmt_message_9(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_9.setKey("session.details.statistics");
  ...
  private boolean _jspx_meth_fmt_message_10(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_10.setKey("session.details.received");
  ...
  private boolean _jspx_meth_fmt_message_11(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_11.setKey("session.details.hostname");
  ...
  private boolean _jspx_meth_fmt_message_12(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_12.setKey("session.details.back_button");
